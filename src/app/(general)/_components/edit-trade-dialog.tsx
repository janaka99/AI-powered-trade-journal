...
export default function EditTradeDialog({
  ...
  async function handleSubmit(data: UpdateTradeInput) {
    ...
    if (data.swap !== undefined) {
      formData.append("swap", String(data.swap));
    }
    if (data.commissions !== undefined) {
      formData.append("commissions", String(data.commissions));
    }
    if (data.notes) {
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Swap (optional)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Commissions (optional)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
