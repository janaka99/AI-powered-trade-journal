...
import { AccountLinking } from "./_components/accounts-linking";
import { AccountDeletion } from "./_components/account-deletion";
import { Badge } from "@/components/ui/badge";
import TwoFactorAuthSection from "./_components/two-factor-enabled";
    ...
    <div className="space-y-6">
      ...
      {hasPasswordAccount && (
        <Card>
          ...
          <CardContent>
            <TwoFactorAuthSection isTwoFactorEnabled={isTwoFactorEnabled} />
          </CardContent>
        </Card>
      )}
      <Card>
